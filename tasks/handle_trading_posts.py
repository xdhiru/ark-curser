...
class TradingPost:
    ...
    def add_to_curse(self):
        heapq.heappush(self.__class__.curse_uncurse_queue, (self.execution_timestamp-60, self, True))  # Push to curse, tuple (execution_timestamp, TradingPost object, do_curse_flag)
